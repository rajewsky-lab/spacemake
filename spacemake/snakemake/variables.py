...
spatial_barcodes = complete_data_root + '/puck_barcode_files/spatialBarcodes_{puck_barcode_file_id}.txt'
parsed_spatial_barcodes = complete_data_root + '/puck_barcode_files/spatial_barcodes_{puck_barcode_file_id}.csv'
