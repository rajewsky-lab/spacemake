...
if (barcode_file){
    fig_width=fig_width * 2
        ...
        obs_df %>%
            ...
            mutate(total_counts = ifelse(total_counts > 60000, 60000, total_counts)) %>%
            ggplot(aes(x_pos, y_pos, color = total_counts)) +
                geom_point(size = snakemake@params$downstream_variables$plot_bead_size)+
                coord_fixed()+
                scale_color_viridis_c(option =  "magma", limits = c(0, 60000),  breaks = c(20000, 30000, 40000, 50000, 60000)) +
