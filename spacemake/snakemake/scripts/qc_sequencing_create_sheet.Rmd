...
#write_rds(snakemake, '/data/rajewsky/home/tsztank/projects/spatial/repos/sts-paper/visium_qc.rds')
```
    ...
    pl <- spatial_qc_dat %>%
        ggplot(aes(x_pos, y_pos, color = val)) +
            ...
            theme(panel.background = element_rect(fill = 'gray95'), 
                ...
                axis.ticks = element_blank(), axis.text=element_blank(), text = element_text(color='black', size=18))
    if(cut_dist){
        pl <- pl +
