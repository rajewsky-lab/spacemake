...
```{r plot_n_reads_bead_hist, echo = F, fig.width=12.5, fig.height=5, dpi=300, results='asis'}
to_plot <- dge_summary %>%
...
```{r plot_nucl_freq, results='asis', fig.width=10, fig.height = 5, echo=F, dpi=300}
