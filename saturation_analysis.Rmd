...
plot_data <- function(umi_cutoff=1){
    dge_data %>%
        filter(NUM_TRANSCRIPTS > umi_cutoff) %>%
        group_by(percentage) %>%
...
```{r plot_umi_1, echo = F, fig.height = 7, fig.width = 7}
plot_data(1) %>% print
```
...
```{r plot_umi_10, echo = F, fig.height = 7, fig.width = 7}
plot_data(10) %>% print
```
...
```{r plot_umi_50, echo = F, fig.height = 7, fig.width = 7}
plot_data(50) %>% print
```
...
```{r plot_umi_100, echo = F, fig.height = 7, fig.width = 7}
plot_data(100) %>% print
```
